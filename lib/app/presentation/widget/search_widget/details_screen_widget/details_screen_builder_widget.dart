                                ...
                                child: Column(
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontWeight:
                                            selectedIndex == index  ? FontWeight.w900  : FontWeight.bold,
                          ...
                          builder: (context, selectedIndex) {
                            return IndexedStack(
                              ...
                              children: [
                                ...
                                DetailsReviewWidget(barber: barber,screenHight: screenHeight,screenWidth: screenWidth)
                              ],
                            );
                          },
                        ),
